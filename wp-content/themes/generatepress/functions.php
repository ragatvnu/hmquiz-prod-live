...
add_action('wp_enqueue_scripts', function () {
         $custom = WP_CONTENT_DIR . '/uploads/hmquiz/hmqz-theme.css';
         if (is_page() && false !== strpos($_SERVER['REQUEST_URI'], '/play/') && file_exists($custom)) {
             wp_enqueue_style(
                 'hmqz-theme',
                 content_url('uploads/hmquiz/hmqz-theme.css'),
                 [],
                 filemtime($custom)
             );
         }
